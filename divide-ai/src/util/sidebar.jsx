...
const Sidebar = ({ drawerOpen, setDrawerOpen }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="h4" fontFamily={"'Jersey 15'"} color="white">
          Menu
        </Typography>
        <Button
          onClick={() => navigate("/profile")}
          endIcon={
            <AccountCircleIcon sx={{ color: "white", height: 32, width: 32 }} />
          }
        />
      </Box>
      <Box
        ...
        <Box sx={{ position: "relative", height: "100%" }}>
          <List sx={{ display: "grid", gap: 3, px: 2 }}>
            ...
            <Button
              ...
              startIcon={<IncompleteCircleIcon />}
            >
              Gráficos
            </Button>
            <Button
          ...
          <Button
            onClick={() => {
              axios.get(backendServerUrl + "/logout", {
